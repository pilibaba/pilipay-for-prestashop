...
<div class="panel">
	<div class="row pilipay-header">
		<div class="col-xs-8 col-md-8">
			<p >
				<img src="{$module_dir|escape:'html':'UTF-8'}logo.png" style="max-width:15%" id="payment-logo" class="pull-left"/>
            ...
            see our 1 minute demo <a target="_blank" href="https://www.youtube.com/watch?v=UvkA_rsmY14&feature=youtu.be"> video </a>
                    
				</p><br />
				
				
				<img src="{$module_dir|escape:'html':'UTF-8'}views/img/capitalflow_01.png" id="capitalflow_01" style="max-width: 100%" /><br />
...
<p>
               ...
               <p class="justify">
				...
				<img src="{$module_dir|escape:'html':'UTF-8'}views/img/capitalflow_02.png" id="capitalflow_02" style="max-width: 100%" />
				
					{if !$configured}
					<div style="background:#eee; padding: 2em; width:55%; margin-top:30px">
					  <br />
					  <button type="button" data-toggle="modal" data-target="#autoRegisterForm" style="background: url({$module_dir|escape:'html':'UTF-8'}views/img/signup.png) no-repeat center center; text-indent: -999em; min-width: 303px; height:52px;border: none" >
					    <b>{l s='Quick active your Pilibaba Account' mod='pilipay'}</b>
					  </button>
					  <br /><br />
						
						Manual registration is available if auto registration is failed <a href="http://en.pilibaba.com/regist?from=prestashop"  style="text-decoration: underline" target="_blank">{l s='Create an account' mod='pilipay'}</a>
						<br /><br />
						{l s='Already have one?' mod='pilipay'}
						<a href="http://en.pilibaba.com/account/login?from=prestashop" target="_blank"> {l s='Log in' mod='pilipay'}</a> {l s='your Pilibaba account and paste your "Merchant Number" and "Secrect-Key" into below fields.' mod='pilipay'}
						
						<br /><br />
						<a href="http://en.pilibaba.com/"  style="text-decoration: underline;color:rgba(23, 37, 235, 0.96)" target="_blank">{l s='Get more information ' mod='pilipay'}</a>
						<br /><br />						
					</div>
					{/if}					            
