 ...
 *
 */
class PilipayOrderdemo extends PilipayModel
{
    // 提交订单的接口地址
    const SUBMIT_TARGET_URL = 'http://pre.pilibaba.com/pilipay/payreq';

    // 更新运单号的接口地址
    const UPDATE_TRACK_URL = 'http://pre.pilibaba.com/pilipay/updateTrackNo';

    // The interface URL for barcode
    // 二维码的接口地址
    const BARCODE_URL = 'http://pre.pilibaba.com/pilipay/barCode';
